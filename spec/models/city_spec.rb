describe City do
  ...
  describe 'instance methods' do
    it 'knows about all the available listings given a date range' do
      expect(City.first.city_openings('2014-05-01', '2014-05-05')).to include(@listing1,@listing2) 
      expect(City.first.city_openings('2014-05-01', '2014-05-05')).to_not include(@listing3)
    end 
  end
